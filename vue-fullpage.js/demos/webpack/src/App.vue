<template>
  <div id="app" >
    ...
    <ul class="actions">
      <li>
        <a class="actions-button" href="#" rel="noopener">则赛报名</a>
      </li>
      <li>
        <a class="actions-button" href="#" rel="noopener">冰幻微博</a>
      </li>
      <li>
        <a class="actions-button" href="#" rel="noopener">冰幻 Twitter</a>
      </li>
    </ul>
    ...
    <full-page :options="options" id="fullpage" > 
      <div class="section"  >
        <div style="padding:10%">
          <h3>时夏格斗祭</h3>
          <center>
            <p class="ppp">冰都幻想乡 - 绯想天则混合线上线下水友赛</p>
          </center>
        </div>
      </div>
      <div class="section">
